...
om={f['path']:f for f in old['files']};nm={f['path']:f for f in new['files']};assert om.keys() <= nm.keys()
changed=[p for p in nm if p not in om or nm[p]['sha256']!=om[p]['sha256']]
label='media-merge'
remote='/home/clients/85f40bb325280e979ad0b9d01cc5b8a6/aw-repair-return-20260915-233425/incoming-'+label
dirs=set()
for p in changed:
