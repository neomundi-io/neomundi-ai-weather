...
const script=fs.readFileSync(target,'utf8').replaceAll('9400','9401');const m=new Module(target,module);m.filename=target;m.paths=module.paths;m._compile(script,target);
